...
jar --create --file mods/main@1.0.jar --module-version=1.0 -C out/main .
jar --create --file mods/books.api@1.0.jar --module-version=1.0 -C out/books.api .
jar --create --file mods/books.impl@1.0.jar --module-version=1.0 -C out/books.impl .
jar --create --file mods/bookstore@1.0.jar --module-version=1.0 -C out/bookstore .
